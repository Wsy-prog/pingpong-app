...
-- 修改 settle_match_elo 使它引用 users 表
...
AS $$
BEGIN
  UPDATE public.users SET elo_score = p1_new_score WHERE id = p1_id;
  UPDATE public.users SET elo_score = p2_new_score WHERE id = p2_id;
